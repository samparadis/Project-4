...
;;;; test_user_defined_procedues 

(define (sums x y z) (+ x y z))
; expect sums
...
(cond_tester 1 2 3) 
; expect cond_works_man

(cond_tester 2000 10 6)
; expect cond_deff_works_man

(cond_tester 2000 10 7)
; expect its_workin

(begin (define (product x y)(* x y)) 'you_will_not_see_this 'you_will_not_see_this_either 'you_will_see_this)
; expect you_will_see_this
...
(car (quote (hello friend)))
; expect hello

(quote (10 (9 hi_there . (8 . 9))))
; expect (10 (9 hi_there 8 . 9))

(eval (cons 'car '('(1000 0))))
; expect 1000
...
(define test_value (lambda (b c) (a (+ b b))))
; expect test_value

(test_value 1000 16)
; expect 2016 

(define s (cons-stream 1 (cons-stream 2 s)))
; expect s
(car (cdr-stream (cdr-stream s)))
; expect 1
